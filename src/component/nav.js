...
export default function Navbar() {
  ...
  return (
    <div className='w-screen h-[80px] z-10 bg-white fixed'>
        <div className='px-5 flex justify-between items-center h-full max-w-[80%] mx-auto border-b-2'>
            ...
            <ul className='hidden md:flex cursor-pointer m-5 font-mono p-6 space-x-6 font-bold text-lg'>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
            ...
            {!nav ? <Bars3Icon className='h-6 w-6 cursor-pointer' />:<XMarkIcon className='h-6 w-6 cursor-pointer' />
              ...
              <ul className={!nav ? 'left-[100%] fixed ': 'absolute bg-white w-full space-y-4'}>
